...
void GPIO_TestTask()
{
    ...
    bool err = gpio_enable_pin_isr(BUTTON_GPIO, GPIO_LEVEL_HIGH, DEBOUNCE_TIME, GPIO_INT_TYPE_RISING_EDGE, callback_example);
    if (!err)
    {
